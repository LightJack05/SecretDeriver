...
# lightjack.de/secretderiver-bundle:$VERSION and lightjack.de/secretderiver-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/LightJack05/SecretDeriver
...
IMG ?= ghcr.io/lightjack05/secretderiver:latest
...
KIND_CLUSTER ?= secretderiver-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name secretderiver-builder
	$(CONTAINER_TOOL) buildx use secretderiver-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm secretderiver-builder
	rm Dockerfile.cross
